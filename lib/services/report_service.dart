...
class ReportService {
  static const String _apiUrl =
      'https://omniguard.blue16.cn/api/v5/report/generate';
  ...
  static Future<String?> generateReport(List<String> detectionIds,
      {int timeout = 100000}) async {
    try {
      ...
      final Map<String, dynamic> requestBody = {
        "token": _token,
        "data": {"detectionIds": detectionIds, "timeout": timeout}
      };
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        if (responseData['code'] == 'SUCCESS' && responseData['data'] != null) {
          ...
          _debugPrint(
              'API响应不成功: ${responseData['code']} - ${responseData['msg']}');
        }
      } else {
    ...
    return ReportResponse(
      ...
      data: json['data'] != null
          ...
          : ReportData(
              ...
              createTime: '',
              detectionIds: [],
              data: ReportFileData(fileKey: '', url: '')),
    );
  }
}
