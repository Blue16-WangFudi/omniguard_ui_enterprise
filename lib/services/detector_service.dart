...
class DetectorService {
  static const String _apiUrl =
      'https://omniguard.blue16.cn/api/v5/detector/multimodal';
  ...
  static Future<DetectionResult?> detectFile(String fileUrl,
      {String mode = 'FAST', String type = 'RISK'}) async {
    try {
      ...
      final objects = [
        {"fileKey": objectKey, "type": fileType}
      ];
      ...
      final result =
          await detectRisks(objects, detectionMode: mode, detectionType: type);
  ...
  /// [type] - Detection type, either 'RISK' or 'AI'
  /// Returns a DetectionResult if successful, null otherwise
  static Future<DetectionResult?> detectText(String textContent,
      {String mode = 'FAST', String type = 'RISK'}) async {
    try {
  ...
  static Future<Map<String, dynamic>?> detectRisks(
      List<Map<String, String>> objects,
      {String detectionMode = 'PRECISE',
      String detectionType = 'RISK'}) async {
    try {
  ...
  static DetectionResult? processMultimodalResponse(
    ...
    try {
      ...
      if (response['code'] == 'SUCCESS' && response['data'] != null) {
        ...
        final suggestions =
            suggestionsList.map((item) => item.toString()).toList();
        ...
        _debugPrint(
            'Successfully parsed detection result with confidence: ${data['confidence']}');
        ...
        _debugPrint(
            'API response does not have the expected format: code=${response['code']}');
      }
    } catch (e) {
  ...
  static ChatMessage createSystemMessageFromResponse(
      Map<String, dynamic> response, String detectionMode) {
    try {
      final detectorResponse = DetectorResponse.fromJson(response);
      _debugPrint(
          'u4eceu68c0u6d4bu54cdu5e94u521bu5efau7cfbu7edfu6d88u606f: ${detectorResponse.status}');

      if (detectorResponse.data.results.isNotEmpty) {
        _debugPrint(
            'u6210u529fu89e3u6790u68c0u6d4bu7ed3u679cu90fdu6709u5206u6790u5185u5bb9');
        ...
        final results = detectorResponse.data.results.map((result) {
          if (result.analysis.overall.isEmpty) {
            ...
            _debugPrint(
                'u7ed3u679cu7f3au5c11u5206u6790u5185u5bb9uff0cu8bbeu7f6eu9ed8u8ba4u503c');
            final analysis = DetectionAnalysis(
                overall:
                    "u53efu80fdu5b58u5728u98ceu9669u5185u5bb9uff0cu8bf7u8c28u614eu5904u7406",
                featurePoints: [
                  FeaturePoint(
                      keyword: "u98ceu9669u5206u7c7b",
                      description: result.category),
                  FeaturePoint(
                      keyword: "u98ceu9669u7ea7u522b",
                      description: result.confidence >= 0.8
                          ? "u9ad8u5ea6u98ceu9669"
                          : (result.confidence >= 0.5
                              ? "u4e2du5ea6u98ceu9669"
                              : "u4f4eu5ea6u98ceu9669")),
                ],
                suggestions: [
                  "u5efau8baeu8fdbu4e00u6b65u6838u5b9eu5185u5bb9u771fu5b9eu6027",
                  "u8c28u614eu5904u7406u76f8u5173u4fe1u606f"
                ]);
            ...
            final analysisJson = jsonEncode({
              ...
              'featurePoints': analysis.featurePoints
                  .map((fp) =>
                      {'keyword': fp.keyword, 'description': fp.description})
                  .toList(),
        ...
        _debugPrint(
            'u6ca1u6709u68c0u6d4bu7ed3u679cuff0cu8fd4u56deu9519u8befu6d88u606f');
        return ChatMessage(
          text:
              "u65e0u6cd5u68c0u6d4bu5185u5bb9u98ceu9669u3002u8bf7u68c0u67e5u60a8u7684u8f93u5165u6216u6587u4ef6u662fu5426u6b63u786eu3002",
          isUser: false,
          thinkingStatus: ThinkingStatus.completed,
        );
      }
      ...
      return ChatMessage(
        text:
            "u68c0u6d4bu5185u5bb9u98ceu9669u53d1u751fu9519u8bef: ${e.toString()}",
        isUser: false,
        thinkingStatus: ThinkingStatus.completed,
      );
    }
  ...
  static Future<ChatMessage> processApiResponseToMessage(
      Map<String, dynamic> requestBody, String detectionMode) async {
    try {
      ...
      _debugPrint(
          'u76f4u63a5APIu8c03u7528u54cdu5e94u72b6u6001: ${response.statusCode}');

      if (response.statusCode >= 200 && response.statusCode < 300) {
        // Before parsing, ensure correct encoding by decoding the bytes with UTF-8
        final decodedResponse = utf8.decode(response.bodyBytes);
        _debugPrint(
            'u76f4u63a5APIu54cdu5e94u4f53(u6b63u786eu89e3u7801): $decodedResponse');
        ...
        _debugPrint(
            'u76f4u63a5APIu8bf7u6c42u5931u8d25,u72b6u6001u7801: ${response.statusCode}');
        return ChatMessage(
          text:
              "u68c0u6d4bu8bf7u6c42u5931u8d25uff0cu72b6u6001u7801: ${response.statusCode}",
          isUser: false,
          thinkingStatus: ThinkingStatus.completed,
        );
      }
