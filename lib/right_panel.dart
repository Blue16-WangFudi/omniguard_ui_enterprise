...
//   const DetectionPanel({super.key, required this.chatInstance, required this.onUpdateInstance});
...
//         // If there's text, detect it by uploading as .txt first
//         if (message.isNotEmpty) {
//           print('检测文本内容: $message');
//           try {
//             DetectionResult? textResult = await DetectorService.detectText(
//               message,
//               mode: _detectionMode,
//               type: _detectionType,
//             );
//             if (textResult != null) {
//               print('检测文本成功: ${textResult.category}, 置信度: ${textResult.confidence}');
//               detectionResults.add(textResult);
//             } else {
//               print('文本检测返回null，尝试直接调用检测API');
              
//               // 直接调用检测API，避免文件上传可能的问题
//               final objects = [{
...
//               if (apiResponse != null) {
//                 print('直接API调用成功');
//                 final result = DetectorService.processMultimodalResponse(apiResponse);
//                 if (result != null) {
...
//             // Only detect uploaded files with URLs
//             print('检测文件内容: ${file.originalName} (${file.uploadedUrl})');
//             DetectionResult? result = await DetectorService.detectFile(
//               file.uploadedUrl!,
//               mode: _detectionMode,
//               type: _detectionType,
//             );
